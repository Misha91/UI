...
class Robot(HMM):
    ...
    def get_states(self):
        ...
        return sorted(self.maze.get_free_positions())
    ...
    def get_observations(self):
        ...
        return sorted(list(product(*sensor_domains)))
